select id,
       ...
       case
         when le.abbreviation = 'Клиники Чайка' then 'e884414e-345f-11e2-9222-f23cea8074d9'
       end                                                                      as store_uuid,
       case
         when le.abbreviation = 'Клиники Чайка' then '4d0460ff-a0cb-11e2-9494-91acf06830ea'
       end                                                                      as company_uuid
  ...
  where date >= '2025-04-01'
    ...
    and le.abbreviation in ('Клиники Чайка')
