select id,
       ...
       case
         when le.abbreviation = 'Чайка Университет' then 'f966000c-3c48-11dd-96d9-000c6e46fcad'
       end                                                                      as store_uuid,
       case
         when le.abbreviation = 'Чайка Университет' then 'c84cdf1b-6720-11ed-a221-00155d59dd05'
       end                                                                      as company_uuid
  ...
  where date >= '2025-04-01'
    ...
    and le.abbreviation in ('Чайка Университет')
