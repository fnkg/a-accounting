select id,
       ...
       case
         when le.abbreviation = 'Чайка Метрополис' then '53cff195-3b3d-11ee-a22a-00155d59dd05'
       end                                                                      as store_uuid,
       case
         when le.abbreviation = 'Чайка Метрополис' then '805250f1-2309-11ef-a230-00155d59dd05'
       end                                                                      as company_uuid
  ...
  where date >= '2025-04-01'
    ...
    and le.abbreviation in ('Чайка Метрополис')
