select id,
       ...
       case
         when le.abbreviation = 'ЧБС' then '28cd7fa6-1c65-11ef-a230-00155d59dd05'
       end                                                                      as store_uuid,
       case
         when le.abbreviation = 'ЧБС' then '0b9f6f47-d30c-11ef-a23b-00155d59dd05'
       end                                                                      as company_uuid
